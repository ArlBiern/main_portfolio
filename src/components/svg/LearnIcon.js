const LearnIcon = () => {
  return (
    <svg className="learn_icon_svg" viewBox="0 0 491.255 491.256">
      <g className="learn_icon">
        <path
          className="learn_brain_element"
          d="M109.041,134.176l-40.443-24.312l59.576-0.8V56.226L41.051,90.077l-17.772,30.618l58.812,25.725c0,0-71.067,0-74.734,0
        ...
        <polygon
          className="learn_brain_element"
          points="400.594,275.043 428.784,288.529 388.357,283.625 403.059,245.651 491.255,239.533 454.497,177.054 
        ...
        <polygon
          className="learn_brain_element"
          points="130.013,143.36 118.832,164.799 135.057,177.054 129.855,195.417 99.232,185.018 77.792,222.98 128.173,259.127 
